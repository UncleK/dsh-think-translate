window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		function ProviderSection() {
			...
			var modelMenuPair = useState(null); var modelMenu = modelMenuPair[0], setModelMenu = modelMenuPair[1];
			var dshMenuPair = useState(false); var dshMenu = dshMenuPair[0], setDshMenu = dshMenuPair[1];
			useEffect(function () {
				var alive = true;
				var tries = 0;
				function attempt() {
			...
			var addingPair = useState(false);
			var adding = addingPair[0], setAdding = addingPair[1];
			var editingIdPair = useState(null);
			var editingId = editingIdPair[0], setEditingId = editingIdPair[1];
			var formNamePair = useState(""); var formName = formNamePair[0], setFormName = formNamePair[1];
			var formTypePair = useState("openai"); var formType = formTypePair[0], setFormType = formTypePair[1];
			var formProviderPair = useState(""); var formProvider = formProviderPair[0], setFormProvider = formProviderPair[1];
			var formProviderMenuPair = useState(false); var formProviderMenu = formProviderMenuPair[0], setFormProviderMenu = formProviderMenuPair[1];
			var formModelMenuPair = useState(false); var formModelMenu = formModelMenuPair[0], setFormModelMenu = formModelMenuPair[1];
			var formBaseURLPair = useState(""); var formBaseURL = formBaseURLPair[0], setFormBaseURL = formBaseURLPair[1];
			var formApiKeyPair = useState(""); var formApiKey = formApiKeyPair[0], setFormApiKey = formApiKeyPair[1];
			var formApiKeyEnvPair = useState(""); var formApiKeyEnv = formApiKeyEnvPair[0], setFormApiKeyEnv = formApiKeyEnvPair[1];
			var formModelPair = useState(""); var formModel = formModelPair[0], setFormModel = formModelPair[1];
