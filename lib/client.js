	...
	factory: (require) => {
		...
		function StatusBlock() {
			...
			return createElement("div", null,
				...
				createElement("div", { className: "xl-kv" },
					...
					createElement("button", {
						className: "xl-btn", type: "button", style: { marginLeft: "auto" },
						onClick: clearCache
					}, t.clearCache)),
		...
		function createProviderRow(id, chain, provs, cfg, t, actions) {
			...
			return createElement("div", {
				...
				// The id says nothing the label has not already said for the fixed
				// built-ins; it is only shown where it is the provider's own name.
				isBuiltin ? null : createElement("span", { className: "xl-provider-name" }, id),
