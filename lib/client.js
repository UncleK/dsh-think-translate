	...
	factory: (require) => {
		...
		var UI_TEXT = {
			"zh-CN": {
				...
				loadingModels: "加载模型…",
				testing: "测试中…", connOk: "连通", connFail: "连接失败（将回退浏览器直连）",
				...
				providerUnused: "可用提供方（未加入）",
				providerAddToChain: "加入",
				providerRemoveFromChain: "移出",
			},
			"en": {
				...
				testing: "Testing…", connOk: "Connected", connFail: "Connection failed (will fall back)",
				...
				providerUnused: "Available providers (not added)",
				providerAddToChain: "Add",
				providerRemoveFromChain: "Remove",
			},
			"ja": {
				...
				testing: "テスト中…", connOk: "接続OK", connFail: "接続に失敗（フォールバックします）",
				...
				providerUnused: "利用可能な提供元（未追加）",
				providerAddToChain: "追加",
				providerRemoveFromChain: "除外",
			},
			"ko": {
				...
				testing: "테스트 중…", connOk: "연결됨", connFail: "연결 실패(폴백)",
				...
				providerUnused: "사용 가능한 제공자(미추가)",
				providerAddToChain: "추가",
				providerRemoveFromChain: "제외",
			},
			"es": {
				...
				testing: "Probando…", connOk: "Conectado", connFail: "Fallo de conexión (usará respaldo)",
				...
				providerUnused: "Proveedores disponibles (sin añadir)",
				providerAddToChain: "Añadir",
				providerRemoveFromChain: "Quitar",
			},
			"fr": {
				...
				testing: "Test en cours…", connOk: "Connecté", connFail: "Échec de connexion (repli)",
				...
				providerUnused: "Fournisseurs disponibles (non ajoutés)",
				providerAddToChain: "Ajouter",
				providerRemoveFromChain: "Retirer",
			},
			"de": {
				...
				testing: "Teste…", connOk: "Verbunden", connFail: "Verbindung fehlgeschlagen (Fallback)",
				...
				providerUnused: "Verfügbare Anbieter (nicht hinzugefügt)",
				providerAddToChain: "Hinzufügen",
				providerRemoveFromChain: "Entfernen",
			},
			"ru": {
				...
				testing: "Проверка…", connOk: "Подключено", connFail: "Сбой соединения (запасной вариант)",
				...
				providerUnused: "Доступные провайдеры (не добавлены)",
				providerAddToChain: "Добавить",
				providerRemoveFromChain: "Убрать",
			},
		};
