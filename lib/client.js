	...
	factory: (require) => {
		...
		var UI_TEXT = {
			"zh-CN": {
				...
				budgetTitle: "用量与每日预算",
				budgetEnable: "启用每日上限（超出后只用免费通道）",
				budgetLimit: "每日上限",
				budgetToday: "今日已用",
				budgetReset: "清零今日",
				priceIn: "输入单价/百万 token",
				priceOut: "输出单价/百万 token",
				providerModel: "模型",
				providerTest: "测试",
				providerEdit: "编辑",
				providerDelete: "删除",
			...
			"en": {
				...
				budgetTitle: "Usage & daily budget",
				budgetEnable: "Enable daily cap (over the cap only free channels are used)",
				budgetLimit: "Daily limit",
				budgetToday: "Spent today",
				budgetReset: "Reset today",
				priceIn: "Input price / 1M tokens",
				priceOut: "Output price / 1M tokens",
				providerModel: "Model",
				providerTest: "test",
				providerEdit: "edit",
			...
			"ja": {
				...
				budgetTitle: "使用量と1日の予算",
				budgetEnable: "1日の上限を有効化（超過後は無料チャネルのみ）",
				budgetLimit: "1日の上限",
				budgetToday: "本日の使用額",
				budgetReset: "本日分をリセット",
				priceIn: "入力単価/100万トークン",
				priceOut: "出力単価/100万トークン",
				providerModel: "Model",
				providerTest: "test",
				providerEdit: "edit",
				providerDelete: "delete",
			...
			"ko": {
				...
				budgetTitle: "사용량 및 일일 예산",
				budgetEnable: "일일 한도 사용(초과 시 무료 채널만 사용)",
				budgetLimit: "일일 한도",
				budgetToday: "오늘 사용액",
				budgetReset: "오늘 초기화",
				priceIn: "입력 단가/100만 토큰",
				priceOut: "출력 단가/100만 토큰",
				providerModel: "Model",
				providerTest: "test",
				providerEdit: "edit",
				providerDelete: "delete",
			...
			"es": {
				...
				budgetTitle: "Uso y presupuesto diario",
				budgetEnable: "Activar límite diario (al superarlo solo canales gratuitos)",
				budgetLimit: "Límite diario",
				budgetToday: "Gastado hoy",
				budgetReset: "Reiniciar hoy",
				priceIn: "Precio de entrada / 1M tokens",
				priceOut: "Precio de salida / 1M tokens",
				providerModel: "Model",
				providerTest: "test",
				providerEdit: "edit",
				providerDelete: "delete",
			...
			"fr": {
				...
				budgetTitle: "Usage et budget quotidien",
				budgetEnable: "Activer le plafond quotidien (au-delà, seuls les canaux gratuits)",
				budgetLimit: "Plafond quotidien",
				budgetToday: "Dépensé aujourd'hui",
				budgetReset: "Réinitialiser aujourd'hui",
				priceIn: "Prix d'entrée / 1M tokens",
				priceOut: "Prix de sortie / 1M tokens",
				providerModel: "Model",
				providerTest: "test",
				providerEdit: "edit",
				providerDelete: "delete",
			...
			"de": {
				...
				budgetTitle: "Nutzung & Tagesbudget",
				budgetEnable: "Tageslimit aktivieren (darüber nur kostenlose Kanäle)",
				budgetLimit: "Tageslimit",
				budgetToday: "Heute ausgegeben",
				budgetReset: "Heute zurücksetzen",
				priceIn: "Eingabepreis / 1 Mio. Token",
				priceOut: "Ausgabepreis / 1 Mio. Token",
				providerModel: "Model",
				providerTest: "test",
				providerEdit: "edit",
				providerDelete: "delete",
			...
			"ru": {
				...
				budgetTitle: "Расход и дневной бюджет",
				budgetEnable: "Включить дневной лимит (сверх лимита — только бесплатные каналы)",
				budgetLimit: "Дневной лимит",
				budgetToday: "Израсходовано сегодня",
				budgetReset: "Сбросить сегодня",
				priceIn: "Цена входа / 1 млн токенов",
				priceOut: "Цена выхода / 1 млн токенов",
				providerModel: "Model",
				providerTest: "test",
				providerEdit: "edit",
				providerDelete: "delete",
		...
		function createProviderRow(id, chain, provs, cfg, t, actions) {
			...
			// Checkbox title: DSH rows are managed by the harness (m8);
			// others show the current enabled state (m7).
			var onTitle = isDsh ? t.providerManaged : (p.enabled !== false ? t.providerOn : t.providerOff);
			// DSH providers are activated by chain membership (see runChainFor),
			// so a DSH row in the chain reads as "on" even though its persisted
			// enabled flag stays false.
			var isChecked = isDsh ? true : (p.enabled !== false);
			return createElement("div", {
				...
				p.priceIn || p.priceOut ? createElement("span", { className: "xl-badge" }, (p.priceIn || 0) + "/" + (p.priceOut || 0) + " per 1M") : null,
				isDsh ? createElement("input", {
					className: "xl-cfg", style: { width: "46px", fontSize: "10px", padding: "0 2px" },
					placeholder: t.priceIn, title: t.priceIn,
					defaultValue: p.priceIn === undefined || p.priceIn === null ? "" : String(p.priceIn),
					onBlur: function (e) { actions.setPrice(id, "priceIn", e.target.value); }
				}) : null,
				isDsh ? createElement("input", {
					className: "xl-cfg", style: { width: "46px", fontSize: "10px", padding: "0 2px" },
					placeholder: t.priceOut, title: t.priceOut,
					defaultValue: p.priceOut === undefined || p.priceOut === null ? "" : String(p.priceOut),
					onBlur: function (e) { actions.setPrice(id, "priceOut", e.target.value); }
				}) : null,
				createElement("input", { type: "checkbox", checked: isChecked, disabled: isDsh, title: onTitle, onChange: function (e) { actions.toggle(id, e.target.checked); } }),
				...
				// Built-ins and DSH providers are read-only entries: removing
				// them from the chain is the way to deactivate (they stay in
				// cfg.providers and can be re-added from the unused area).
				isBuiltin || isDsh ? createElement("button", { className: "xl-btn", type: "button", onClick: function () { actions.removeFromChain(id); } }, t.providerRemoveFromChain) : null,
				!isDsh && !isBuiltin ? createElement("button", { className: "xl-btn", type: "button", onClick: function () { actions.edit(id); } }, t.providerEdit) : null,
				!isDsh && !isBuiltin ? createElement("button", { className: "xl-btn", type: "button", onClick: function () { actions.del(id); } }, t.providerDelete) : null);
		}
		...
		function ProviderSection() {
			...
			var usagePair = useState(null); var usage = usagePair[0], setUsage = usagePair[1];
			var limitPair = useState(""); var budgetLimitText = limitPair[0], setBudgetLimitText = limitPair[1];
			useEffect(function () {
				var alive = true;
				var tries = 0;
				function attempt() {
			...
			// The ledger follows the config: every save can change the meter, so a
			// fresh read is one dependency away instead of a manual refresh button.
			useEffect(function () {
				if (!cfg) return undefined;
				var alive = true;
				fetch("/_xlate/usage").then(function (r) { return r.json(); })
					.then(function (u) { if (alive && u && u.ok) { setUsage(u); setBudgetLimitText(u.budget && u.budget.dailyLimit !== undefined ? String(u.budget.dailyLimit) : ""); } })
					.catch(function () {});
				return function () { alive = false; };
			}, [cfg]);
			useEffect(function () {
			...
			var formPriceInPair = useState(""); var formPriceIn = formPriceInPair[0], setFormPriceIn = formPriceInPair[1];
			var formPriceOutPair = useState(""); var formPriceOut = formPriceOutPair[0], setFormPriceOut = formPriceOutPair[1];
			...
			var actions = {
				...
				setPrice: function (id, field, raw) {
					var v = String(raw).trim();
					// An emptied input means "not metered" (0), never "keep the old value":
					// the patch route drops undefined fields, so 0 is the only way to clear it.
					var n = v === "" ? 0 : Number(v);
					if (!isFinite(n) || n < 0) return;
					var patch = { providers: {} };
					patch.providers[id] = {};
					patch.providers[id][field] = n;
					applyLocal(patch);
					saveCfg(patch);
				},
				...
				fbAdd: function (id) {
					var fb = cfgRef.current.fallback || {};
					var fbChain = Array.isArray(fb.chain) ? fb.chain.slice() : [];
					if (fbChain.indexOf(id) >= 0) return;
					fbChain.push(id);
					applyLocal({ fallback: { chain: fbChain } });
					saveCfg({ fallback: { chain: fbChain } });
				},
				fbRemove: function (id) {
					var fb = cfgRef.current.fallback || {};
					var fbChain = Array.isArray(fb.chain) ? fb.chain.filter(function (x) { return x !== id; }) : [];
					applyLocal({ fallback: { chain: fbChain } });
					saveCfg({ fallback: { chain: fbChain } });
				},
				test: function (id) {
				...
				edit: function (id) {
					...
					setFormPriceIn(p.priceIn === undefined || p.priceIn === null ? "" : String(p.priceIn));
					setFormPriceOut(p.priceOut === undefined || p.priceOut === null ? "" : String(p.priceOut));
			...
			var submitForm = function () {
				...
				providers[id] = {
					...
					apiKeyEnv: formApiKeyEnv.trim(),
					priceIn: formPriceIn.trim() === "" ? undefined : Number(formPriceIn),
					priceOut: formPriceOut.trim() === "" ? undefined : Number(formPriceOut),
			...
			if (adding || editingId) {
				formArea = createElement("div", { className: "xl-add-form" },
					...
					createElement("input", {
						className: "xl-cfg", placeholder: t.priceIn, value: formPriceIn,
						onChange: function (e) { setFormPriceIn(e.target.value); }
					}),
					createElement("input", {
						className: "xl-cfg", placeholder: t.priceOut, value: formPriceOut,
						onChange: function (e) { setFormPriceOut(e.target.value); }
					}),
					createElement("input", {
			...
			var budget = cfg.budget || { enabled: false, dailyLimit: 0 };
			var budgetSpent = usage && typeof usage.spent === "number" ? usage.spent : 0;
			var budgetArea = createElement("div", { style: { marginTop: "8px" } },
				createElement("div", { className: "xl-note", style: { fontWeight: 600 } }, t.budgetTitle),
				createElement("label", null,
					createElement("input", {
						type: "checkbox", checked: budget.enabled === true,
						onChange: function (e) {
							var patch = { budget: { enabled: e.target.checked } };
							applyLocal(patch); saveCfg(patch);
						}
					}),
					createElement("span", null, t.budgetEnable)),
				createElement("div", { style: { display: "flex", gap: "6px", alignItems: "center", marginTop: "2px" } },
					createElement("span", { style: { fontSize: "11px", opacity: 0.6 } }, t.budgetLimit),
					createElement("input", {
						className: "xl-cfg", style: { width: "90px" }, value: budgetLimitText,
						onChange: function (e) { setBudgetLimitText(e.target.value); },
						onBlur: function () {
							var patch = { budget: { dailyLimit: Number(budgetLimitText) || 0 } };
							applyLocal(patch); saveCfg(patch);
						}
					})),
				createElement("div", { className: "xl-note", style: { marginTop: "2px" } },
					t.budgetToday + ": " + budgetSpent.toFixed(4) +
					(budget.enabled === true && Number(budget.dailyLimit) > 0 ? " / " + Number(budget.dailyLimit) : "")),
				usage && usage.today && usage.today.providers ? Object.keys(usage.today.providers).map(function (id) {
					var row = usage.today.providers[id] || {};
					return createElement("div", { key: "u" + id, className: "xl-note", style: { fontSize: "11px", opacity: 0.7 } },
						id + ": " + Number(row.cost || 0).toFixed(4) + "  (" + (row.calls || 0) + " calls, " + (row.input || 0) + "/" + (row.output || 0) + " tok)");
				}) : null,
				createElement("button", {
					className: "xl-btn", type: "button", style: { marginTop: "2px" },
					onClick: function () {
						fetch("/_xlate/usage", { method: "POST", headers: { "Content-Type": "application/json" }, body: "{}" })
							.then(function () { return fetch("/_xlate/usage"); })
							.then(function (r) { return r.json(); })
							.then(function (u) { if (u && u.ok) setUsage(u); })
							.catch(function () {});
					}
				}, t.budgetReset));
			var fb = cfg.fallback || {};
			var fbEnabled = fb.enabled !== false;
			var fbChain = Array.isArray(fb.chain) ? fb.chain : ["google", "bing"];
			...
			return createElement("div", null,
				...
				createElement("label", null,
					createElement("input", {
						type: "checkbox", checked: fbEnabled,
						onChange: function (e) {
							var patch = { fallback: { enabled: e.target.checked } };
							applyLocal(patch);
							saveCfg(patch);
						}
					}),
					createElement("span", null, t.fallbackToggle)),
				fbEnabled ? createElement("div", { className: "xl-fallback-chain" },
					createElement("span", null, t.fallbackChain + ":"),
					fbChain.map(function (id) {
						var fp = provs[id] || {};
						return createElement("span", { className: "xl-fallback-provider", key: id },
							providerLabel(id, fp, t),
							createElement("button", {
								className: "xl-btn", type: "button", style: { marginLeft: "4px", padding: "0 4px" },
								title: t.providerRemoveFromChain,
								onClick: function () { actions.fbRemove(id); }
							}, "×"));
					}),
					createElement("select", {
						className: "xl-sel", style: { marginLeft: "4px", fontSize: "11px" },
						value: "", onChange: function (e) {
							if (e.target.value) { actions.fbAdd(e.target.value); e.target.value = ""; }
						}
					},
						createElement("option", { value: "" }, "+ " + t.providerAddToChain),
						Object.keys(provs).filter(function (pid) { return fbChain.indexOf(pid) < 0; }).map(function (pid) {
							var pp = provs[pid] || {};
							return createElement("option", { key: pid, value: pid }, pid + " (" + providerLabel(pid, pp, t) + ")");
						}))) : null,
				modelArea,
