window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		function ProviderSection() {
			...
			var modelArea = null;
			// Model download area: shown when the built-in openai provider is
			// active AND points at a local Ollama endpoint (the picker/pull
			// flow only makes sense for local models). `priority` is legacy —
			// chain membership now drives execution.
