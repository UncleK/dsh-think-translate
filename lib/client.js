window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		function createProviderRow(id, chain, provs, cfg, t, actions) {
			...
			var label = id === "openai" && !isDsh ? t.labels.openai
				: p.type === "openai" ? t.providerOpenAICompat
				...
				unusedArea = createElement("div", { className: "xl-unused", style: { marginTop: "8px" } },
					...
					unused.map(function (id) {
						...
						return createElement("div", { key: id, className: "xl-provider-row" },
							createElement("span", { className: "xl-provider-type" }, (t.labels[up.type] || up.type)),
							createElement("span", { className: "xl-provider-name" }, id),
							isDsh ? createElement("span", { className: "xl-badge" }, t.providerDsh) : null,
				...
				fbEnabled ? createElement("div", { className: "xl-fallback-chain" },
					...
					createElement("select", {
						...
						Object.keys(provs).filter(function (pid) { return fbChain.indexOf(pid) < 0; }).map(function (pid) {
							var pp = provs[pid] || {};
							return createElement("option", { key: pid, value: pid }, pid + " (" + (t.labels[pp.type] || pp.type) + ")");
						}))) : null,
				modelArea,
