	...
	factory: (require) => {
		...
		var UI_TEXT = {
			...
			"en": {
				...
				presetLabel: "Preset",
				presetCustom: "Custom (fill in yourself)",
				providerModel: "Model",
				providerTest: "test",
				providerEdit: "edit",
			...
			"es": {
				...
				presetCustom: "Personalizado (rellénalo tú)",
				providerModel: "Model",
				providerTest: "test",
				providerEdit: "edit",
				providerDelete: "delete",
			...
			"fr": {
				...
				presetCustom: "Personnalisé (à remplir)",
				providerModel: "Model",
				providerTest: "test",
				providerEdit: "edit",
				providerDelete: "delete",
			...
			"de": {
				...
				presetLabel: "Vorlage",
				presetCustom: "Benutzerdefiniert (selbst ausfüllen)",
				providerModel: "Model",
				providerTest: "test",
				providerEdit: "edit",
				providerDelete: "delete",
			...
			"ru": {
				...
				presetLabel: "Шаблон",
				presetCustom: "Свой (заполнить вручную)",
				providerModel: "Model",
				providerTest: "test",
				providerEdit: "edit",
				providerDelete: "delete",
		...
		function StatusBlock() {
			...
			return createElement("div", null,
				...
				// The button keeps its own row, left-aligned with the labels above it
				// instead of floating at the far right.
				createElement("div", { className: "xl-kv", style: { marginTop: "4px" } },
					createElement("button", { className: "xl-btn", type: "button", onClick: clearCache }, t.clearCache)),
		...
		function ProviderSection() {
			...
			var actions = {
				...
				test: function (id) {
					...
					fetch("/_xlate/translate", { method: "POST", headers: { "Content-Type": "application/json" },
						...
						.then(function (j) { setMsg(j && j.ok ? t.connOk + " ✓ (" + id + ")" : (t.connFail + ": " + (j.error || "unknown"))); })
			...
			var submitForm = function () {
				...
				var id = editingId || formName.trim();
				if (!id) return;
			...
			if (adding || editingId) {
				formArea = createElement("div", { className: "xl-add-form" },
					createElement("input", {
						className: "xl-cfg", placeholder: t.providerName, value: formName, disabled: !!editingId,
						onChange: function (e) { setFormName(e.target.value); }
					}),
					createElement("label", { style: { display: "flex", gap: "6px", alignItems: "center" } },
						createElement("span", { style: { flex: "0 0 auto", fontSize: "11px", opacity: 0.6 } }, t.providerType),
					...
					createElement("label", { style: { display: "flex", gap: "6px", alignItems: "center" } },
						createElement("span", { style: { flex: "0 0 auto", fontSize: "11px", opacity: 0.6 } }, t.presetLabel),
						createElement("select", {
							className: "xl-sel", style: { flex: "1 1 auto" }, value: formPreset,
					...
					createElement("input", {
						className: "xl-cfg", placeholder: t.providerBaseURL, value: formBaseURL,
					...
					createElement("input", {
						className: "xl-cfg", placeholder: t.providerApiKeyEnv, value: formApiKeyEnv,
