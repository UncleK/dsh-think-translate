window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		var CSS_TEXT = [
			...
			".xl-badge{font-size:9px;padding:1px 5px;border-radius:4px;background:var(--dsw-alias-brand-primary,#4c9aff);color:#fff;font-weight:600}",
		...
		var UI_TEXT = {
			...
			"es": {
				...
				providerDrag: "Arrastra para reordenar",
			...
			"fr": {
				...
				providerDrag: "Glisser pour réordonner",
			...
			"de": {
				...
				providerDrag: "Zum Sortieren ziehen",
			...
			"ru": {
				...
				providerDrag: "Перетащите для порядка",
