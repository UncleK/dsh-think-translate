window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		function createProviderRow(id, chain, provs, cfg, t, actions) {
			var p = provs[id] || {};
			var isBuiltin = id === "google" || id === "bing";
			...
			return createElement("div", {
				...
				createElement("input", { type: "checkbox", checked: p.enabled !== false, disabled: isDsh, title: onTitle, onChange: function (e) { actions.toggle(id, e.target.checked); } }),
			...
			return createElement("div", null,
				...
				fbEnabled ? createElement("div", { className: "xl-fallback-chain" },
					...
					fbChain.map(function (id) {
						var fp = provs[id] || {};
						return createElement("span", { className: "xl-fallback-provider", key: id }, (t.labels[fp.type] || id));
					})) : null,
				modelArea,
