window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		// once one is picked the model field offers that provider's usual models. Both
		// stay free text — a private gateway or a brand-new model is never blocked by
		// this list.
		// Known endpoints, grouped by provider: the form suggests provider NAMES, and
		// once one is picked the model field offers that provider's usual models (the
		// cheap, translation-worthy ones first). Both stay free text — a private gateway
		// or a brand-new model is never blocked by this list.
		var PROVIDER_PRESETS = [
		{ type: "openai", name: "DeepSeek", baseURL: "https://api.deepseek.com/v1", env: "DEEPSEEK_API_KEY", models: ["deepseek-chat", "deepseek-reasoner"] },
		{ type: "openai", name: "OpenAI", baseURL: "https://api.openai.com/v1", env: "OPENAI_API_KEY", models: ["gpt-4o-mini", "gpt-4.1-mini", "gpt-4o", "gpt-4.1", "o4-mini"] },
		{ type: "openai", name: "阿里云百炼", baseURL: "https://dashscope.aliyuncs.com/compatible-mode/v1", env: "DASHSCOPE_API_KEY", models: ["qwen-turbo", "qwen-plus", "qwen-max", "qwen-long"] },
		{ type: "openai", name: "智谱 GLM", baseURL: "https://open.bigmodel.cn/api/paas/v4", env: "ZHIPUAI_API_KEY", models: ["glm-4-flash", "glm-4-flashx", "glm-4-air", "glm-4-plus"] },
		{ type: "openai", name: "月之暗面 Kimi", baseURL: "https://api.moonshot.cn/v1", env: "MOONSHOT_API_KEY", models: ["moonshot-v1-8k", "moonshot-v1-32k", "moonshot-v1-128k", "kimi-latest"] },
		{ type: "openai", name: "硅基流动", baseURL: "https://api.siliconflow.cn/v1", env: "SILICONFLOW_API_KEY", models: ["Qwen/Qwen2.5-7B-Instruct", "Qwen/Qwen2.5-14B-Instruct", "Qwen/Qwen2.5-32B-Instruct", "deepseek-ai/DeepSeek-V3"] },
		{ type: "openai", name: "OpenRouter", baseURL: "https://openrouter.ai/api/v1", env: "OPENROUTER_API_KEY", models: ["openai/gpt-4o-mini", "anthropic/claude-3.5-haiku", "google/gemini-2.0-flash-001", "deepseek/deepseek-chat"] },
		{ type: "anthropic", name: "Anthropic", baseURL: "https://api.anthropic.com", env: "ANTHROPIC_API_KEY", models: ["claude-3-5-haiku-latest", "claude-3-7-sonnet-latest", "claude-sonnet-4-5", "claude-opus-4-1"] },
		];
		var UI_TEXT = {
			"zh-CN": {
