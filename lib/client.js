window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		{ type: "openai", name: "OpenAI", baseURL: "https://api.openai.com/v1", env: "OPENAI_API_KEY", models: ["gpt-4o-mini", "gpt-4o"] },
		{ type: "openai", name: "阿里云百炼", baseURL: "https://dashscope.aliyuncs.com/compatible-mode/v1", env: "DASHSCOPE_API_KEY", models: ["qwen-turbo", "qwen-plus"] },
		{ type: "openai", name: "智谱 GLM", baseURL: "https://open.bigmodel.cn/api/paas/v4", env: "ZHIPUAI_API_KEY", models: ["glm-4-flash", "glm-4-air"] },
		{ type: "openai", name: "月之暗面 Kimi", baseURL: "https://api.moonshot.cn/v1", env: "MOONSHOT_API_KEY", models: ["moonshot-v1-8k", "moonshot-v1-32k"] },
		{ type: "openai", name: "硅基流动", baseURL: "https://api.siliconflow.cn/v1", env: "SILICONFLOW_API_KEY", models: ["Qwen/Qwen2.5-7B-Instruct", "Qwen/Qwen2.5-14B-Instruct"] },
		{ type: "openai", name: "OpenRouter", baseURL: "https://openrouter.ai/api/v1", env: "OPENROUTER_API_KEY", models: ["openai/gpt-4o-mini", "anthropic/claude-3.5-haiku"] },
		{ type: "anthropic", name: "Anthropic", baseURL: "https://api.anthropic.com", env: "ANTHROPIC_API_KEY", models: ["claude-3-5-haiku-latest", "claude-sonnet-4-5"] },
		];
		var UI_TEXT = {
			"zh-CN": {
		...
		function ProviderSection() {
			...
			if (adding || editingId) {
				...
				createElement("input", {
					className: "xl-cfg", style: { flex: "0 0 140px" }, list: "xl-provider-presets",
					placeholder: t.presetCustom, value: formProvider,
					onChange: function (e) { onProviderChange(e.target.value); }
				}),
				createElement("datalist", { id: "xl-provider-presets" },
					PROVIDER_PRESETS.map(function (pp) {
						if (pp.type !== formType) return null;
						return createElement("option", { key: pp.name, value: pp.name });
					})),
				createElement("input", {
					className: "xl-cfg", style: { flex: "1 1 auto" }, list: "xl-model-presets",
					placeholder: t.providerModel, value: formModel,
					onChange: function (e) { setFormModel(e.target.value); }
				}),
				createElement("datalist", { id: "xl-model-presets" },
					modelsForProvider(formProvider).map(function (m) {
						return createElement("option", { key: m, value: m });
					}))),
				createElement("label", { className: "xl-form-row" },
		...
		function SettingsPanel() {
			...
			return createElement("div", { className: "xl-panel" },
				...
				createElement("div", { className: "xl-about" },
					createElement("span", null, (about && about.name ? about.name : "dsh-think-translate") + (about && about.version ? " v" + about.version : "")),
					createElement("a", {
						className: "xl-btn", style: { textDecoration: "none" },
						href: (about && about.repo) ? about.repo : "https://github.com/UncleK/dsh-think-translate",
